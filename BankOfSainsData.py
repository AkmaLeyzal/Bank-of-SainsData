...
def decryption():
    with open(resource_path('key.key'), 'rb') as key_file:
        key = key_file.read()

    with open(resource_path('config.enc'), 'rb') as enc_file:
...
class BankSainsData:
    def __init__(self, bsd):
        ...
        bg_image = Image.open(resource_path("images\Frame 25 (2).png"))
        ...
        def quitApp():
            ...
            bg3_image = Image.open(resource_path("images\Frame 52.png"))
    ...
    def set_taskbar_icon(self):
        ...
        icon_path = os.path.join(os.path.dirname(application_path), resource_path("images\BSDLogo.ico"))
    ...
    def forgot(self):
        ...
        bg_image = Image.open(resource_path("images\Frame 58.png"))
        resize_imge = bg_image.resize((1280, 720))
        ...
        def lanjut():
            ...
            if rowForgot is not None:
                ...
                if passwordNew is not None and pinNew.isdigit() and passwordNew!='Password Baru' and len(pinNew) == 6:
                    bg3_image = Image.open(resource_path("images\Frame 59 (1).png"))
                    ...
                    def otp_button():
                        ...
                        if email_tujuan != "Email" and email_tujuan is not None and "@gmail.com" in email_tujuan:
                            ...
                            bg3_image = Image.open(resource_path("images\Frame 60 (2).png"))
                            ...
                            def submit_checkOTP():
                                ...
                                if codeOTP == otpCODE:
                                    ...
                                    bg3_image = Image.open(resource_path("images\Frame 62.png"))
                            ...
                            bg3_image = Image.open(resource_path("images\Frame 63.png"))
                            resize_image = bg3_image.resize((219, 227))
                            self.photo2 = ImageTk.PhotoImage(resize_image)
                    ...
                    bg3_image = Image.open(resource_path("images\Frame 67.png"))
                    resize_image = bg3_image.resize((219, 227))
                    self.photo2 = ImageTk.PhotoImage(resize_image)
                    ...
                    bg3_image = Image.open(resource_path("images\Frame 66.png"))
                    resize_image = bg3_image.resize((219, 227))
                    self.photo2 = ImageTk.PhotoImage(resize_image)
                ...
                bg3_image = Image.open(resource_path("images\Frame 64.png"))
                resize_image = bg3_image.resize((219, 227))
                self.photo2 = ImageTk.PhotoImage(resize_image)
    ...
    def signup(self):
        ...
        bg_image = Image.open(resource_path("images\Frame 12 (5).png"))
        resize_imge = bg_image.resize((1280, 720))
        photo2 = ImageTk.PhotoImage(resize_imge)
            ...
            if checkbox_var.get():
                if row_username is None and usernamee!='Username':
                    if passwordd.isalnum():
                        if pinn.isdigit() and len(str(pinn)) == 6 :
                            ...
                            if norekk.isdigit() and len(str(norekk)) == 11 and row_norek is None:
                                if depoo.isdigit() and int(depoo) >= 150000:
                                    ...
                                    bg3_image = Image.open(resource_path("images\Frame 32.png"))
                                    resize_image = bg3_image.resize((219, 227))
                                    self.photo2 = ImageTk.PhotoImage(resize_image)
                                ...
                                bg3_image = Image.open(resource_path("images\Frame 56.png"))
                                resize_image = bg3_image.resize((219, 227))
                                self.photo2 = ImageTk.PhotoImage(resize_image)
                                ...
                                bg3_image = Image.open(resource_path("images\Frame 31.png"))
                                resize_image = bg3_image.resize((219, 227))
                                self.photo2 = ImageTk.PhotoImage(resize_image)
                            ...
                            bg3_image = Image.open(resource_path("images\Frame 29.png"))
                            resize_image = bg3_image.resize((219, 227))
                            self.photo2 = ImageTk.PhotoImage(resize_image)
                        ...
                        bg3_image = Image.open(resource_path("images\Frame 28.png"))
                        resize_image = bg3_image.resize((219, 227))
                        self.photo2 = ImageTk.PhotoImage(resize_image)
                    ...
                    bg3_image = Image.open(resource_path("images\Frame 27.png"))
                    resize_image = bg3_image.resize((219, 227))
                    self.photo2 = ImageTk.PhotoImage(resize_image)
                    ...
                    bg3_image = Image.open(resource_path("images\Frame 68.png"))
                    resize_image = bg3_image.resize((219, 227))
                    self.photo2 = ImageTk.PhotoImage(resize_image)
        ...
        def syarat_dan_ketentuan():
            ...
            def page5():
                def page4():
                    def page3():
                        def page2():
                            ...
                            bg3_image = Image.open(resource_path("images\Frame 70 (1).png"))
                        ...
                        bg3_image = Image.open(resource_path("images\Frame 73 (1).png"))
                        resize_image = bg3_image.resize((500, 600))
                        self.photo2 = ImageTk.PhotoImage(resize_image)
                    ...
                    bg3_image = Image.open(resource_path("images\Frame 72 (1).png"))
                    resize_image = bg3_image.resize((219, 227))
                    self.photo2 = ImageTk.PhotoImage(resize_image)
                ...
                bg3_image = Image.open(resource_path("images\Frame 71 (1).png"))
                resize_image = bg3_image.resize((500, 600))
                self.photo2 = ImageTk.PhotoImage(resize_image)
            ...
            bg3_image = Image.open(resource_path("images\Frame 69 (5).png"))
            resize_image = bg3_image.resize((500, 600))
            self.photo2 = ImageTk.PhotoImage(resize_image)
    ...
    def login(self):
        ...
        if row is not None and username!="Username" and password!="Password" and username!="" and password!="":
            ...
            bg3_image = Image.open(resource_path("images\Frame 33.png"))
            resize_image = bg3_image.resize((219, 227))
            self.photo2 = ImageTk.PhotoImage(resize_image)
            ...
            bg3_image = Image.open(resource_path("images\Frame 35.png"))
            resize_image = bg3_image.resize((219, 227))
            self.photo2 = ImageTk.PhotoImage(resize_image)
    ...
    def Main_frame(self):
        ...
        bg3_image = Image.open(resource_path("images\Frame 24 (4).png"))  #Firdaini Azmi (23031554071)
        ...
        def quitbuttonM():
            ...
            bg3_image = Image.open(resource_path("images\Frame 51.png"))
        ...
        image_path = "images\Frame 53 (1).png"  
        img = Image.open(resource_path(image_path))
        resize_img = img.resize((90,90))
    ...
    def loadHistory(self, username):
        ...
        for row in rows:
            ...
            try:
                ...
                bg3_image = Image.open(resource_path("images\Frame 42.png"))
    ...
    def infotf(self):   #Firdaini Azmi (23031554071)
        ...
        bg3_image = Image.open(resource_path("images\Frame 78.png"))
    ...
    def newTransfer(self):
        def submit_pin_tf():
            ...
            if row_pin is not None and PIN_tf1 is not None:
                ...
                bg3_image = Image.open(resource_path("images\Frame 10.png"))
                resize_image = bg3_image.resize((211, 293))
                self.photo2 = ImageTk.PhotoImage(resize_image)
                ...
                bg3_image = Image.open(resource_path("images\Frame 34.png"))
                resize_image = bg3_image.resize((219, 227))
                self.photo2 = ImageTk.PhotoImage(resize_image)
        ...
        if row5 is not None and norek!=myReke:
            if str(nominalTF).isdigit():
                if self.balance - int(nominalTF)>= 20000:
                    if self.balance >= int(nominalTF):
                        if int(nominalTF) >= 10000:
                            ...
                            bg3_image = Image.open(resource_path("images\Frame 47 (2).png"))
                            ...
                            def next_transaksi():
                                ...
                                bg3_image = Image.open(resource_path("images\Frame 9.png"))
                                resize_image = bg3_image.resize((211, 293))
                                self.photo2 = ImageTk.PhotoImage(resize_image)
                            ...
                            self.next.place(x=310, y=240)                
                                ...
                                bg3_image = Image.open(resource_path("images\Frame 48.png"))
                                resize_image = bg3_image.resize((219, 227))
                                self.photo2 = ImageTk.PhotoImage(resize_image)
                            ...
                            bg3_image = Image.open(resource_path("images\Frame 37.png"))
                            resize_image = bg3_image.resize((219, 227))
                            self.photo2 = ImageTk.PhotoImage(resize_image)
                        ...
                        bg3_image = Image.open(resource_path("images\Frame 49.png"))
                        resize_image = bg3_image.resize((219, 227))
                        self.photo2 = ImageTk.PhotoImage(resize_image)
                    ...
                    bg3_image = Image.open(resource_path("images\Frame 36 (1).png"))  #Firdaini Azmi (23031554071)
                    resize_image = bg3_image.resize((219, 227))
                    self.photo2 = ImageTk.PhotoImage(resize_image)
                ...
                bg3_image = Image.open(resource_path("images\Frame 76 (1).png"))
                resize_image = bg3_image.resize((219, 227))
                self.photo2 = ImageTk.PhotoImage(resize_image)
                ...
                bg3_image = Image.open(resource_path("images\Frame 22.png"))
                resize_image = bg3_image.resize((219, 227))
                self.photo2 = ImageTk.PhotoImage(resize_image)
    ...
    def depo(self):
        def pin_depo():
            ...
            if str(nominalD).isdigit():
                ...
                bg3_image = Image.open(resource_path("images\Frame 36 (1).png"))  #Akmal Rizal (23031554078)
                resize_image = bg3_image.resize((219, 227))
                self.photo2 = ImageTk.PhotoImage(resize_image)
        ...
        bg3_image = Image.open(resource_path("images\Frame 14 (2).png"))   #Akmal Rizal (23031554078)
    ...
    def withdraww(self):
        def pin_wd():
            ...
            if str(nominalW).isdigit():
                ...
                bg3_image = Image.open(resource_path("images\Frame 36 (1).png"))   #Nova Aulia Agustin (23031554022)
                resize_image = bg3_image.resize((219, 227))
                self.photo2 = ImageTk.PhotoImage(resize_image)
        ...
        bg3_image = Image.open(resource_path("images\Frame 15 (5).png"))  #Nova Aulia Agustin (23031554022)
        resize_image = bg3_image.resize((450, 300))
        self.photo2 = ImageTk.PhotoImage(resize_image)
    ...
    def Ecommerce(self):
        ...
        bg3_image = Image.open(resource_path("images\Frame 16 (1).png"))
    ...
    def beliPulsa(self):
        def pinP():
            ...
            if str(nominalP).isdigit():
                        ...
                        if int(nominalP) >= 10000:
                            if str(noHP).isdigit():
                                if 12<= len(str(noHP)) <=13:
                                    ...
                                    bg3_image = Image.open(resource_path("images\Frame 21.png"))
                                    resize_image = bg3_image.resize((219, 227))
                                    self.photo2 = ImageTk.PhotoImage(resize_image)
                                ...
                                bg3_image = Image.open(resource_path("images\Frame 41.png"))
                                resize_image = bg3_image.resize((219, 227))
                                self.photo2 = ImageTk.PhotoImage(resize_image)
                ...
                bg3_image = Image.open(resource_path("images\Frame 36 (1).png"))  #Muhammad Fabyan Putroagung (23031554029)
                resize_image = bg3_image.resize((219, 227))
                self.photo2 = ImageTk.PhotoImage(resize_image)
        ...
        bg3_image = Image.open(resource_path("images\Frame 17 (2).png"))       #Muhammad Fabyan Putroagung (23031554029)
    ...
    def beliListrik(self):
        def pinL():
            ...
            if str(nominalL).isdigit():
                        ...
                        if int(nominalL) >= 10000:
                            if str(tokenL).isdigit():
                                if 12<= len(tokenL) <=13:
                                    ...
                                    bg3_image = Image.open(resource_path("images\Frame 26.png"))
                                    resize_image = bg3_image.resize((219, 227))
                                    self.photo2 = ImageTk.PhotoImage(resize_image)
                ...
                bg3_image = Image.open(resource_path("images\Frame 36 (1).png"))   #Michael Fahrudin (23031554139)
                resize_image = bg3_image.resize((219, 227))
                self.photo2 = ImageTk.PhotoImage(resize_image)
        ...
        bg3_image = Image.open(resource_path("images\Frame 18 (2).png"))  #Michael Fahrudin (23031554139)
        resize_image = bg3_image.resize((520, 620))
        self.photo2 = ImageTk.PhotoImage(resize_image)
